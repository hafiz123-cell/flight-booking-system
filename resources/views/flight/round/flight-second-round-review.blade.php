        ...
        <div class="col-xl-3">
            ...
            <div class="bg-white shadow-sm rounded mb-4 border p-3">
                <ul class="list-unstyled small mb-2">
                    ...
                    @if($extraServices > 0)
                    <li class="text-muted d-flex justify-content-between gap-2" style="font-size: 13px; line-height: 1;"><strong class="my-1 fw-semibold" style="font-size: 14px;">Meal & Baggage:</strong> <span>₹{{ number_format($extraServices, 2) }}</span></li>
                    @endif
                </ul>
                ...
                <ul class="list-unstyled small mb-2">
                    <li class="text-muted d-flex justify-content-between gap-2" style="font-size: 13px; line-height: 1;"><strong class="my-1 fw-semibold" style="font-size: 14px;">Total Amount:</strong> <span>₹{{ number_format($totalAmount, 2) }}</span></li>
                    ...
                    <li class="mt-2">
                        ...
                        <div class="collapse mt-2" id="amountBreakdown">
                            <ul class="list-unstyled ms-3">
                                <li class="text-muted mb-2 d-flex justify-content-between gap-2" style="font-size: 13px; line-height: 1;"><span>Commission:</span> -₹{{ number_format($commission, 2) }}</li>
                                ...
                                @if($extraServices > 0)
                                <li class="text-muted mb-2 d-flex justify-content-between gap-2" style="font-size: 13px; line-height: 1;"><span>Meal & Baggage:</span> <span>+₹{{ number_format($extraServices, 2) }}</span> </li>
                                @endif
