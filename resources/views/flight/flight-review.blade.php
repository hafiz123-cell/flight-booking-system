        ...
        <div class="col-xl-9">
            ...
            <div class="bg-white shadow-sm rounded p-3 mb-4 border">
                ...
                $startFrame = ($start < 24) ? "{$start} hrs" : intval($start / 24) . " days" ;
                    ...
                    <div class="mt-2">
                        <button class="btn btn-sm" style="background-color: #f5f5f5;color: rgb(255, 138, 5);width: fit-content;font-size: 11px;padding: 4px 8px 3px;" onclick="toggleDetails('{{ 'fare_toggle_' . $index }}', this)">
                            Fare Rules +
                        </button>

                        @php $indexId = 'fare_toggle_' . $index; @endphp

                        <div id="{{ $indexId }}_tab_content" class="d-none mt-2" style="background-color:#eeecec;">
