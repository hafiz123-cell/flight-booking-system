                    ...
                    <div class="col-lg-4 col-sm-12">
                        <div class="footer-about">
                            <div class="footer-about-in mar-bottom-30">
                                <h3 class="white">Need Goflyhabibi Help?</h3>
                                <div class="footer-phone">
                                    ...
                                    <div class="cont-content mar-left-20">
                                        ...
                                        <p class="bold mar-0"><span>Call Us:</span> +91 6359259244/22</p>
                                    </div>
                                </div>
                            </div>
                            <h3 class="white">Contact Info</h3>
                            <p>
                                PO Box: +91 6359259244/22<br />
                                Location: 302, Venus Avan Business Center, Bhat
...
382428.
                            ...
                            <ul class="social-links">
                                <li>
                                    <a href="#"><i class="fab fa-facebook mt-2" aria-hidden="true"></i></a>
                                </li>
                                <li>
                                    <a href="#"><i class="fab fa-twitter mt-2" aria-hidden="true"></i></a>
                                </li>
                                <li>
                                    <a href="#"><i class="fab fa-instagram mt-2" aria-hidden="true"></i></a>
                                </li>
                                <li>
                                    <a href="#"><i class="fab fa-linkedin mt-2" aria-hidden="true"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-links">
                            ...
                            <ul>
                                <li><a href="/">Home</a></li>
                                <li><a href="/flight">Flight Service</a></li>
            ...
            <div class="container">
                <div class="pay-main display-flex space-between">
                    <div class="footer-logo pull-left">
                        <a href="/"><h1 class="header-logo">Goflyhabibi</h1></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="footer-copyright">
            <div class="container">
                <div class="copyright-text pull-left">
                    <p class="mar-0">2025 GoFlyHabibi. All rights reserved.</p>
                </div>
                <div class="footer-nav pull-right">
                    <ul>
                        ...
                        <li><a href="/cancellationandpaymentpolicy">Cancellation & Payment Policy</a></li>
                        <li><a href="{{route('contact')}}">Contact us</a></li>
                    </ul>
                </div>
            </div>
    ...
    {{-- <script src="{{ asset('js/custom-swiper3.js') }}"></script> --}}
...
<script>
    ...
    @stack('scripts') <!-- Optional: for child views to push custom scripts -->
</body>
</html>