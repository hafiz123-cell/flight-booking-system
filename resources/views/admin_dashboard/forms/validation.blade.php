@extends('admin_dashboard.layouts.vertical', ['subtitle' => 'Form Validation'])

@section('content')
@include('admin_dashboard.layouts.partials.page-title', ['title' => 'Form', 'subtitle' => 'Form Validation'])
